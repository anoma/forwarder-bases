...
```*/
    ...
    impl IImplementationCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[170u8, 241u8, 15u8, 66u8]];
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IImplementationCalls {
        const NAME: &'static str = "IImplementationCalls";
    ...
    /**Creates a new wrapper around an on-chain [`IImplementation`](self) contract instance.

See the [wrapper's documentation](`IImplementationInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> IImplementationInstance<P, N> {
        IImplementationInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IImplementationInstance<P, N>>,
    > {
        IImplementationInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IImplementationInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`IImplementation`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IImplementation`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IImplementationInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IImplementationInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IImplementationInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<IImplementationInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IImplementationInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IImplementationInstance<P, N> {
            IImplementationInstance {
