...
```*/
    ...
    impl ILogicRefSpecificCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[203u8, 173u8, 0u8, 229u8]];
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ILogicRefSpecificCalls {
        const NAME: &'static str = "ILogicRefSpecificCalls";
    ...
    ///Container for all the [`ILogicRefSpecific`](self) custom errors.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum ILogicRefSpecificErrors {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ILogicRefSpecificErrors {
        const NAME: &'static str = "ILogicRefSpecificErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
    ...
    /**Creates a new wrapper around an on-chain [`ILogicRefSpecific`](self) contract instance.

See the [wrapper's documentation](`ILogicRefSpecificInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> ILogicRefSpecificInstance<P, N> {
        ILogicRefSpecificInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ILogicRefSpecificInstance<P, N>>,
    > {
        ILogicRefSpecificInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ILogicRefSpecificInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`ILogicRefSpecific`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ILogicRefSpecific`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ILogicRefSpecificInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for ILogicRefSpecificInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ILogicRefSpecificInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<ILogicRefSpecificInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> ILogicRefSpecificInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ILogicRefSpecificInstance<P, N> {
            ILogicRefSpecificInstance {
